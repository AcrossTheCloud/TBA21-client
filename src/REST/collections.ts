...
export const getCollectionCollectionsId = async (queryStringParameters: Object = {}) => {
  const response = await API.get('tba21', 'collections/getCollectionCollectionsId', { queryStringParameters });
  return response.data;
};
