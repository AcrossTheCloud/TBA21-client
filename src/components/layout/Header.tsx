                ...
                <Collapse isOpen={this.state.isOpen} navbar>
                  <Nav className="ml-auto float-right" navbar>
                    ...
                    {isAuthenticated ?
                      <>
                        <NavItem>
                          <a className="nav-link" href="mailto:matthew@tba21-academy?cc=mark@tba21-academy.org&subject=Ocean%20Archive%20support%20request&body=Please%20provide%20as%20many%20details%20as%20possible">Help</a>
                        </NavItem>
                        <NavItem>
