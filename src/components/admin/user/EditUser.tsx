    ...
    if (this.state.changedGroups && this.state.changedGroups.length) {
      ...
      const addGroup = async (groupName: string): Promise<void> => {
        try {
          ...
          let win = window.open(`mailto:${this.state.userEmail}?subject=Ocean%20Archive%20group%20membership%20change&body=This%20email%20is%20to%20inform%20you%20that%20you%20have%20been%20added%20to%20the%20${groupName}%20group%20on%20the%20Ocean%20Archive.`);
