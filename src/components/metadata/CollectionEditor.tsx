                  ...
                  <Col xs="12">
                    ...
                    <FormGroup>
                      ...
                      <Select
                          ...
                          options={licenseType}
                          value={collection.license ? {value: collection.license as License, label: collection.license} : {value: 'Ocean Archive' as License, label: 'Ocean Archive (most restrictive)'}}
                          onChange={e => {
