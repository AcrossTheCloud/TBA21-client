...
import { Item, itemText } from '../../types/Item';
import {
  countries,
  itemAudioSubTypes,
  itemImageSubTypes,
...
export class ItemEditor extends React.Component<Props, State> {
  ...
  AcademicPublication = () => {
    ...
    return (
      <Row className="academic_publication">
        <Col md="6">
          <FormGroup>
          ...
          <Col md="8">
            ...
            <TabContent activeTab={this.state.activeTab}>
              <TabPane tabId="1">
                ...
                {item.item_subtype === itemText.Policy_Paper || itemText.Report ? <this.PolicyPaperReport /> : <></>}
