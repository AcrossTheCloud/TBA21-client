  ...
  SubType = (): JSX.Element => {
    ...
    return (
      <Select
        ...
        onChange={e => this.validateLength('item_subtype', e.value)}
        isSearchable
      />
    );
  };
        ...
        <Col md="6">
          <FormGroup>
            ...
            <Select
              ...
              onChange={e => this.changeItem('translated_from', e.value)}
              isSearchable
            />
          </FormGroup>
        </Col>
        ...
        <Col md="6">
          <FormGroup>
            ...
            <Input
              ...
              onChange={e => this.validateLength('event_title', e.target.value)}
            />
            <FormFeedback>This is a required field</FormFeedback>
          </FormGroup>
        </Col>
        ...
        <Col md="6">
          <FormGroup>
            ...
            <TimeField
              ...
              showSeconds
              onChange={e =>
                this.changeItem('duration', moment.duration(e).asSeconds())
              }
        ...
        <Col md="6">
          <FormGroup>
            ...
            <Input
              ...
              onChange={e => this.changeItem('episode_number', e.target.value)}
            />
          </FormGroup>
        </Col>
        <Col md="6">
                    ...
                    <Col xs="12">
                      <FormGroup>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            this.validateLength('description', e.target.value)
                          }
                          invalid={
                            this.state.validate.hasOwnProperty('description') &&
                      ...
                      <FormGroup>
                        ...
                        <FormFeedback
                          style={{
                            display:
                              this.state.validate.hasOwnProperty('regions') &&
                              !this.state.validate.regions
                                ? 'block'
                                : 'none'
                          }}
                        >
                      ...
                      <FormGroup>
                        ...
                        <Select
                          ...
                          onChange={e => this.changeItem('language', e.value)}
                          isSearchable
                        />
                      </FormGroup>
                      ...
                      (!!item.file && item.file.type === FileTypes.Video) ? (
                      ...
                      (!!item.file && item.file.type === FileTypes.Image) ? (
                        <this.ItemImage />
                      ) : (
                        <></>
                      )}
...
export default connect(
  mapStateToProps,
  { modalToggle, getProfileDetails }
)(ItemEditorClass);

interface WithCollapseProps extends Props {
  isOpen?: boolean;
}
function withCollapse<P extends WithCollapseProps>(
  ...
  return class CollapsedItemDisplay extends React.Component<
    P & WithCollapseProps,
    WithCollapseState
  > {
    constructor(props: P) {
        ...
        <>
          <Row className="accordianCollapse">
            ...
            <Col className="creators" onClick={this.toggleCollapse} xs="4">
              {this.state.item.creators ? (
                this.state.item.creators.join(', ')
              ) : (
                <></>
              )}
            </Col>
...
export const ItemEditorWithCollapse = connect(
  mapStateToProps,
  { modalToggle, getProfileDetails }
