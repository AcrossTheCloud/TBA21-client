      ...
      return (
        <>
          <Row className="itemDetails" >
            <Col className="itemIcons" xs="1" sm="1"  onClick={this.toggleCollapse}>
            ...
            <Col className="creators" onClick={this.toggleCollapse} xs="4" sm="3">
            ...
            <Col className="removeButton" xs="1" sm="1">
