...
export const NotFound404Message = (props: { pathName: string | JSX.Element | undefined }): JSX.Element => {
  return (<div className="container-fluid main blue">
    <h2>{'404: Your requested path ' + props.pathName + ' is not found.'}</h2>
  </div>);
};
